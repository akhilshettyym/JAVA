package akhilshettyym.JAVA.MyCode.Z_Assignments.Feb_20;
 ...
 * 
 * This will first take the name using day. and it'll obtain the first letter
 * say M from Monday
 * Then the rest of the string will be converted to lowercase that is from index
 * 1.
 * for first %s wll return the formatted day
 * This will check wtr the day is weekday or weekend from above
 * if user inputs sanday/ funday the Day.valueOf(input will throw an error) this
